...
<div class=" flex flex-col items-center mb-3">
    <div class="flex items-start gap-2.5">
        ...
        <div class="flex flex-col w-full max-w-[520px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-xl dark:bg-gray-700">
       ...
       <div>
       <h3 class="text-xl text-white whitespace-nowrap">{{ post.title }}</h3>
