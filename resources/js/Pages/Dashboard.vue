...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="flex flex-col">
            ...
            <div class=" items-center justify-center flex flex-col mt-7">
                <CodeEditor value="Type the code you want to add as an Anki card here" width="70%" height="500px" class="code-editor" :line-nums="true" :tab-spaces="4" :lang-list-display="true" :languages="[['JavaScript'],['cpp', 'C++'],['python', 'Python'],['php', 'PHP']]" />
                <div class="text-center">
                    <button @click="show()" class="text-white bg-slate-900 hover:bg-black font-medium rounded-lg text-sm px-5 py-2.5 mb-2   focus:outline-none " type="button" data-drawer-target="drawer-swipe" data-drawer-show="drawer-swipe" data-drawer-placement="bottom" data-drawer-edge="true" data-drawer-edge-offset="bottom-[60px]" aria-controls="drawer-swipe">
                        Add card to deck
                    </button>
                </div>

                <div id="drawer-swipe" class="fixed z-40 w-full overflow-y-auto border-t border-gray-200 rounded-t-lg dark:border-gray-700 bg-slate-950 transition-transform bottom-0 left-0 right-0 translate-y-full " tabindex="-1" aria-labelledby="drawer-swipe-label">
  ...
  </svg>Create new deck</h5>
   </div>
   <div class="grid grid-cols-3 gap-4 p-4 lg:grid-cols-4">
      <div class="p-4 rounded-lg cursor-pointer bg-zinc-950 hover:bg-gray-100 dark:hover:bg-gray-600 ">
         ...
         <div class="font-medium text-center text-gray-500 dark:text-gray-400">JavaScript</div>
      </div>
      <div class="p-4 rounded-lg cursor-pointer bg-zinc-950 hover:bg-gray-100 dark:hover:bg-gray-600 ">
         <div class="flex justify-center items-center p-2 mx-auto mb-2 bg-gray-200 dark:bg-gray-600 rounded-full w-[48px] h-[48px] max-w-[48px] max-h-[48px]">
         ...
         <div class="font-medium text-center text-gray-500 dark:text-gray-400">PHP</div>
      </div>
      <div class="hidden p-4 rounded-lg cursor-pointer bg-zinc-950 hover:bg-gray-100 dark:hover:bg-gray-600  lg:block">
         <div class="flex justify-center items-center p-2 mx-auto mb-2 bg-gray-200 dark:bg-gray-600 rounded-full w-[48px] h-[48px] max-w-[48px] max-h-[48px]">
         ...
         <div class="font-medium text-center text-gray-500 dark:text-gray-400">Vue 3</div>
      </div>
      <div class="p-4 rounded-lg cursor-pointer bg-zinc-950 hover:bg-gray-100 dark:hover:bg-gray-600 ">
         <div class="flex justify-center items-center p-2 mx-auto mb-2 bg-gray-200 dark:bg-gray-600 rounded-full w-[48px] h-[48px] max-w-[48px] max-h-[48px]">
         ...
         <div class="font-medium text-center text-gray-500 dark:text-gray-400">Laravel</div>
      </div>
      <div class="p-4 rounded-lg cursor-pointer bg-zinc-950 hover:bg-gray-100 dark:hover:bg-gray-600 ">
         <div class="flex justify-center items-center p-2 mx-auto mb-2 bg-gray-200 dark:bg-gray-600 rounded-full w-[48px] h-[48px] max-w-[48px] max-h-[48px]">
         ...
         <div class="font-medium text-center text-gray-500 dark:text-gray-400">HTML</div>
      </div>
      <div class="p-4 rounded-lg cursor-pointer bg-zinc-950 hover:bg-gray-100 dark:hover:bg-gray-600 ">
         <div class="flex justify-center items-center p-2 mx-auto mb-2 bg-gray-200 dark:bg-gray-600 rounded-full w-[48px] h-[48px] max-w-[48px] max-h-[48px]">
         ...
         <div class="font-medium text-center text-gray-500 dark:text-gray-400">CSS</div>
      </div>
      <div class="hidden p-4 rounded-lg cursor-pointer bg-zinc-950 hover:bg-gray-100 dark:hover:bg-gray-600  lg:block">
         <div class="flex justify-center items-center p-2 mx-auto mb-2 bg-gray-200 dark:bg-gray-600 rounded-full w-[48px] h-[48px] max-w-[48px] max-h-[48px]">
            <svg class="inline w-5 h-5 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
         ...
         <div class="font-medium text-center text-gray-500 dark:text-gray-400">Svelte</div>
      </div>
      <div class="p-4 rounded-lg cursor-pointer bg-zinc-950 hover:bg-gray-100 dark:hover:bg-gray-600 ">
         <div class="flex justify-center items-center p-2 mx-auto mb-2 bg-gray-200 dark:bg-gray-600 rounded-full w-[48px] h-[48px] max-w-[48px] max-h-[48px]">
         ...
         <div class="font-medium text-center text-gray-500 dark:text-gray-400">SQL</div>
      </div>
   </div>
</div>
...
.code-editor {
  ...
  border: 1px solid rgb(1, 16, 32) /* Light gray border */
}

/* Style the button to be more aligned with modern UIs */
.button-add {
  transition: background-color 0.3s ease;
  display: block; /* Ensure it's centered below the editor */
  margin: 20px auto 0; /* Adds some space above the button and centers it */
}
